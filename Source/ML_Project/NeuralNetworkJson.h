...
public:
	...
	static void FNeuralNetworkJson::SerializeToJson(TSharedPtr<FJsonObject> const& JsonObject
		, FString const& JsonFileName);
	static TArray<uint32> const& FNeuralNetworkJson::DeserializeNbNeuronsJson(TSharedPtr<FJsonObject> const& JsonObject);
	static TArray<double> const& FNeuralNetworkJson::DeserializeNeuronsWeightsJson(TSharedPtr<FJsonObject> const& JsonObject,
